...
// newMockSegmentScanner creates a new instance of mockSegmentScanner. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockSegmentScanner(t testing.TB) *mockSegmentScanner {
