...
type mockConstructorTestingTNewMockCachingProcess interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockCachingProcess creates a new instance of MockCachingProcess. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockCachingProcess(t mockConstructorTestingTNewMockCachingProcess) *MockCachingProcess {
